...
<div class="content">
	 ...
	 <div class="title"><h2>Modifier produit</h2></div>
	 <div class="row">
         <div class="col-md-6"> 
  <form name="formAdd" style="margin:60px"  action="" method="post"  enctype="multipart/form-data">
                
                   <div class="user-details">
                   <div class="input-box">
                   <span class="details">Name</span>
                   <input type="text" name="txtMatricule"   placeholder="Entrer Maricule de voiture" required>
                   </div>

                   <div class="input-box">
                   <span class="details">Categorie</span>
                   <input type="text" name="txtMarque"  placeholder="Entrer la Marque de voiture" required>
                   </div>

                   <div class="input-box">
                   <span class="details">Prix </span>
                   <input type="text" name="txtPL"  placeholder="Entrer un le prix de vente de voiture" required>
                   </div>
