...
<div class="sidebar">
  ...
  <a href="Ajout.jsp">Add product</a>
  <a href="orders.jsp">vent en cours</a>
...
<div class="content">
  ...
  <form name="formAdd" style="margin:60px"  action="UploadServlet" method="post"  enctype="multipart/form-data">
                   ...
                   <input type="text" name="price"  value="<%=rs.getDouble(4)%>" >
                   </div>
    			   
                   <div class="input-box">
                   <span class="details">Photo</span>
                   <input type="file" name="image"  value="src='<%=rs.getString(5)%>'" >
                   </div>
